...
X=X/stdX
X=np.hstack((X[:,1:-1],y_new))  #cut out the ozone and day
                                #and combine it with 
...
attributeNames = [u'Offset']+attributeNames[1:-1].tolist()+['Spring','Summer','Fall','Winter']
...
# ***** ARTIFICIAL NEURAL NETWORK & BASELINE MODEL ***** #
